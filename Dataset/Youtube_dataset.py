...
class YoutubeDataset(Dataset):
    def __init__(
        ...
        self.root = root
        self.url = "http://leitang.net/code/social-dimension/data/youtube.mat"
    ...
    def process(self):
        ...
        mat_content = scipy.io.loadmat(Path(self.raw_dir) / "youtube.mat")
...
if __name__ == "__main__":
    root_path = Path(__file__).parents[1] / "Data" / "Youtube"
    dataset = YoutubeDataset(root=str(root_path), compute_features=True)
    print(dataset[0])
    print(dataset[0].x[45])
