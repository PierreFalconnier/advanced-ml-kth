...
if __name__ == "__main__":
    ...
    from Dataset.Youtube_dataset import YoutubeDataset

    # dataset
    dataset_name = "Youtube"
    DATA_DIR = ROOT / "Data" / dataset_name
    dataset = YoutubeDataset(root=DATA_DIR, compute_features=True)[0]
    ...
    model.fit(dataset, num_epoch=10, batch_size=512 * 2, lr=0.0001, path=RESULT_PATH)
